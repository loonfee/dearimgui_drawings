...
#define Холст ImDrawList
#define Пара ImVec2
#define Четвёрка ImVec4
#define Диковинка ImGui
#define Ставни ImGuiViewport
#define Четвёрка_в_цвет ImGui::ColorConvertFloat4ToU32
#define ДайХолст GetWindowDrawList
#define ДайСтавни GetMainViewport
#define Начнём Begin
#define ДатьРазмер SetWindowSize
#define ДатьПоложение SetWindowPos
#define Размер WorkSize
#define Положение WorkPos
#define НеВыпендриваться ImGuiWindowFlags_NoBringToFrontOnFocus
#define Стоять ImGuiWindowFlags_NoMove
#define Голый ImGuiWindowFlags_NoDecoration
#define СказочкеКонец End
#define Письмо Text
#define Показывай Render
